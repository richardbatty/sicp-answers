...
(define (safe? column-no positions)
  (if (= (length positions) 1)
      true
      (not (or (same-row (position-in-last-column positions column-no) (positions-excluding-column positions column-no))
               (same-diagonal (position-in-last-column positions column-no) (positions-excluding-column positions column-no))))))
...
* Attempted refactoring of Exercise 2.42
